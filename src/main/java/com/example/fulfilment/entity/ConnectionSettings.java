...
/**
 * Sealed base class for connection settings. Similar to sealed trait in Scala. Each connection type
 * has its own specific fields. Using sealed class allows exhaustive pattern matching in switch
 * expressions (Java 21+).
 */
