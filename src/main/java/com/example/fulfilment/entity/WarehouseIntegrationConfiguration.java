...
/**
 * Entity for storing warehouse integration connection configurations. Uses a sealed-trait-like
 ...
 */
@Entity
@Table(name = "warehouse_integration_configurations")
@Getter
@Setter
@NoArgsConstructor
public class WarehouseIntegrationConfiguration {
  ...
  /**
   * Pattern matching helper method. Returns the connection settings for pattern matching with
   * switch expressions.
   */
